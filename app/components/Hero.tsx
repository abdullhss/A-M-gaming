            ...
            card: (
              <section className='relative rounded-2xl overflow-hidden w-full h-full'>
                <video 
                  ...
                  loop 
                  muted 
                  className='object-top object-cover absolute inset-0 w-full h-full sm:object-center'
                >
                ...
                <CardInfo 
                  ...
                  className="absolute bottom-8 left-4 right-4 sm:bottom-16 sm:left-8 sm:right-8"
                />
              </section>
            ), 
            src: "/poster.webp"
          }, 
          {
            card: (
              <section className='relative rounded-2xl overflow-hidden w-full h-full'>
                ...
                <CardInfo 
                  btnClasses="bg-orange-600 hover:bg-orange-900" 
                  textBtn='Find out more !' 
            ...
            card: (
              <section className='relative rounded-2xl overflow-hidden w-full h-full'>
                <Image 
                  alt='Hero-photo' 
                  fill 
                  className='object-cover absolute w-full inset-0 h-full sm:object-center' 
                  src={"/Dragon-Ball-Sparking-Zero-Hero-desktop-01-03oct24.webp"} 
                />
                <CardInfo 
                  btnClasses="bg-white text-black hover:bg-yellow-400" 
                  textBtn='Find out more !' 
                  ...
                  className="absolute bottom-8 left-4 right-4 sm:bottom-16 sm:left-8 sm:right-8" // Adjust position for mobile
                />
              </section>
            ), 
            src: "/Dragon-Ball-Sparking-Zero-Hero-desktop-01-03oct24.webp"
